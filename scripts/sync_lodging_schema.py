...
/// Cleaners and maintainers roster (Manager-managed; CM assigns by name).
model lodging_cm_staff {
  id         Int      @id @default(autoincrement())
  HotelName  String
  /// cleaner | maintainer
  role       String
  ...
  @@index([HotelName])
  @@index([HotelName, role])
  @@index([HotelName, role, isActive])
  @@unique([HotelName, role, firstName, lastName])
}
